  ...
  render() {
    ...
    switch (status) {
      ...
      case 'firstDay':
        ...
        containerStyle = momentPrefix
          ? {
              backgroundColor: day.inRangeBackColor,
              borderTopEndRadius: day.selectedBorderRadius,
              borderBottomEndRadius: day.selectedBorderRadius,
            }
          : {
              backgroundColor: day.inRangeBackColor,
              borderTopStartRadius: day.selectedBorderRadius,
              borderBottomStartRadius: day.selectedBorderRadius,
            };
        break;
      ...
      case 'lastDay':
        ...
        containerStyle = momentPrefix
          ? {
              backgroundColor: day.inRangeBackColor,
              borderTopLeftRadius: day.selectedBorderRadius,
              borderBottomLeftRadius: day.selectedBorderRadius,
            }
          : {
              backgroundColor: day.inRangeBackColor,
              borderTopRightRadius: day.selectedBorderRadius,
              borderBottomRightRadius: day.selectedBorderRadius,
            };
        break;
          ...
          {circleStyle || circleOutlineStyle ? (
            <View style={circleStyle ? circleStyle : circleOutlineStyle}>
              <Text
                style={[
                  {
                    color: circleOutlineStyle ? day.todayTextColor : textColor,
                  },
                  { ...day.textStyle },
                ]}>
                {momentPrefix
            ...
            <Text style={[{ color: textColor }, { ...day.textStyle }]}>
              {momentPrefix
                ? moment(date).format(`${momentPrefix}D`)
                : date.getDate()}
            </Text>
